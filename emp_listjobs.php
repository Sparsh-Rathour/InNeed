...
<form method="post" action="emp.listjobs.php"  name="list_jobs"  onsubmit="return listjobs()">
        ...
        <div class="form-group">
        	<div class="input-group">
                ...
                <input id="textbox" class="form-control" type="text" name="website" placeholder="Website" >			
            </div>
        </div>
        <div class="form-group">
        	<div class="input-group">
                ...
                <input id="textbox" class="form-control" type="number" name="emp_id" placeholder="Your Employer ID" >			
            </div>
        </div>
